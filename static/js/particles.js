...
$( document ).ready(function() {
	...
	var ParticleNetwork = function(parent) {
		this.options = {
			...
			netLineDistance: 200,
			netLineColor: '#4BF9EB',
			particleColors: ['#4BF9EB'] // ['#6D4E5C', '#aaa', '#FFC458' ]
		};
		this.canvas = parent.canvas;
		this.ctx = parent.ctx;
...
pna = new ParticleNetworkAnimation();	pna.init($('.particle-network-animation')[0]); pna.init($('.particle-network-animation')[1]); pna.init($('.particle-network-animation')[2]);
